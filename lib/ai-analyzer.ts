...
const analyzeWithAnthropic = async ({ imageDataUrl, source }: AnalyzeCaptureInput) => {
  ...
  const defaultSolvePrompt = [
    "You are an expert problem solver. Analyze the screenshot carefully and solve the problem completely.",
    "",
    "DETECT the problem type first:",
    "",
    "--- IF SQL / CODING PROBLEM ---",
    "1. Read the FULL problem statement and ALL requirements visible in the screenshot.",
    "2. Note the database engine (SQLite, MySQL, PostgreSQL, etc.) and adjust syntax accordingly.",
    "3. Identify all visible table schemas, sample data, and expected output.",
    "4. Think through the logic step by step before writing code.",
    "5. Write a complete, correct, ready-to-run solution.",
    "6. Use this structure:",
    "Problem Summary: (one line)",
    "Approach: (brief reasoning)",
    "```sql",
    "-- your solution here",
    "```",
    "Why It Works: (explain each key clause)",
    "",
    "--- IF MULTIPLE CHOICE ---",
    "1. Read every visible option carefully.",
    "2. Evaluate each option as TRUE or FALSE with a short reason.",
    "3. Use this structure:",
    "Problem Summary: (one line)",
    "Option Check:",
    "- Option A: TRUE/FALSE - reason",
    "- Option B: TRUE/FALSE - reason",
    "Final Answer: (letter + value)",
    "",
    "--- GENERAL RULES ---",
    "- Prefer correctness over brevity.",
    "- Do not guess unreadable text; state what is unclear.",
